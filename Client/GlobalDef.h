/****************************************************************
 *		 This client was writen by Diuuude & Snoopy81. 	* Based on
 * Cleroth work.						*
 *																*
 *			V3.51 compatibility by Cleroth
 *		* V3.51 dialogs by Diuuude
 *		* Effects, mobs, Apocalypse, Heldenian 	* & finalizing by
 * Snoopy81							* V3.82 Crafting
 * & Angels by Snoopy81					*
 *****************************************************************/
...
// #define DEF_USING_WIN_IME		// Used for unicode characters
// (unchecked)
...
#define DEF_COMMA_GOLD // Allows to show comma nbe as original HB (ie:
                       // 1,200,000)
// #define DEF_4XXP_PER_LVL		// limits xp niv 140, then 4 x XP per
// lvl (affects XP shown as % on status)

// #define  _DEBUG				// Multi-Client, Instant-logout,
// Version check, Badwords,
//  Mics debug msgs, CtrlQ for admins, Show status, Cursor position
#define DEF_WINDOWED_MODE // Shows HB in a windowed mode (for debug purpose
// only, sprite will bug....)

...
float4 TexturePixelShader(PixelInput input) : SV_TARGET
{
    ...
    // VISUAL FIX: "Soft Shadows" / "Less Aggressive Blacks"
    // We lift the black level slightly (linear interpolation).
    // Pure Black (0.0) becomes Dark Charcoal (0.045). White (1.0) stays White.
    // Adjusted to 0.045 upon request (+1.5% from 0.03).
